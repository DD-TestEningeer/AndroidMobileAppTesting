...
public class AppManagementWithTestNGAssertions {
    ...
    public void testAppManagement() throws MalformedURLException, InterruptedException {
        ...
        try {
            ...
            Assert.assertEquals(appState, "NOT_RUNNING", "The app should be in the running state.");
            ...
            Assert.assertEquals(appState, 0, "The app should be terminated.");
            ...
            appState = driver.queryAppState(APP_PACKAGE);
            Assert.assertEquals(appState, "RUNNING_IN_FOREGROUND", "The app should be in the running state after background.");
